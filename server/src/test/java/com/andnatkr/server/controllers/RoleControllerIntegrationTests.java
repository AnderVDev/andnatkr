...
public class RoleControllerIntegrationTests {
    ...
    @Autowired
    public RoleControllerIntegrationTests(RoleService roleService, MockMvc mockMvc) {
    ...
    public void testThatCreateRolesSuccessfullyReturnsSavedRole() throws Exception {
        ...
        mockMvc.perform(
                ...
                MockMvcResultMatchers.jsonPath(".id").value(testRoleAdmin.getId())
        ).andExpect(
                MockMvcResultMatchers.jsonPath(".description").value(testRoleAdmin.getDescription())
        );
    }
